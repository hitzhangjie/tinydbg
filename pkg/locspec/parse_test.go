...
func TestFunctionLocationParsing(t *testing.T) {
	...
	assertNormalLocationSpec(t, "github.com/hitzhangjie/dlv/pkg/proc.(*Process).Continue", NormalLocationSpec{"github.com/hitzhangjie/dlv/pkg/proc.(*Process).Continue", &FuncLocationSpec{PackageName: "github.com/hitzhangjie/dlv/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, -1})
	assertNormalLocationSpec(t, "github.com/hitzhangjie/dlv/pkg/proc.Process.Continue", NormalLocationSpec{"github.com/hitzhangjie/dlv/pkg/proc.Process.Continue", &FuncLocationSpec{PackageName: "github.com/hitzhangjie/dlv/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, -1})
	assertNormalLocationSpec(t, "github.com/hitzhangjie/dlv/pkg/proc.Continue", NormalLocationSpec{"github.com/hitzhangjie/dlv/pkg/proc.Continue", &FuncLocationSpec{PackageName: "github.com/hitzhangjie/dlv/pkg/proc", BaseName: "Continue"}, -1})

	// Function locations, package paths, line offsets
	assertNormalLocationSpec(t, "github.com/hitzhangjie/dlv/pkg/proc.(*Process).Continue:10", NormalLocationSpec{"github.com/hitzhangjie/dlv/pkg/proc.(*Process).Continue", &FuncLocationSpec{PackageName: "github.com/hitzhangjie/dlv/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, 10})
	assertNormalLocationSpec(t, "github.com/hitzhangjie/dlv/pkg/proc.Process.Continue:10", NormalLocationSpec{"github.com/hitzhangjie/dlv/pkg/proc.Process.Continue", &FuncLocationSpec{PackageName: "github.com/hitzhangjie/dlv/pkg/proc", ReceiverName: "Process", BaseName: "Continue"}, 10})
	assertNormalLocationSpec(t, "github.com/hitzhangjie/dlv/pkg/proc.Continue:10", NormalLocationSpec{"github.com/hitzhangjie/dlv/pkg/proc.Continue", &FuncLocationSpec{PackageName: "github.com/hitzhangjie/dlv/pkg/proc", BaseName: "Continue"}, 10})
}
