...
Currently supports linux/amd64 and linux/arm64 core files, windows/amd64 
minidumps and core files generated by Delve's 'dump' command.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		os.Exit(execute(0, []string{args[0]}, args[1], debugger.ExecutingOther, args))
	},
}
